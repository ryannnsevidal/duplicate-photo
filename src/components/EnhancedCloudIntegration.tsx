...
// Define more specific types for cloud provider APIs
interface GoogleCredentialResponse {
  credential?: string;
  // Add other properties if available from the response
}
      ...
      window.google.accounts.id.initialize({
        ...
        callback: async (response: GoogleCredentialResponse) => {
          try {
            ...
            throw new Error('An unknown error occurred during Google Picker setup.');
          }
        }
      });
