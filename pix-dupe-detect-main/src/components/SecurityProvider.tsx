...
export function SecurityProvider({ children }: SecurityProviderProps) {
  ...
  useEffect(() => {
    ...
    cspMeta.content = [
      ...
      "connect-src 'self' https://*.supabase.co https://www.google-analytics.com https://accounts.google.com https://oauth2.googleapis.com https://www.googleapis.com https://apis.google.com https://api.dropboxapi.com https://content.dropboxapi.com",
